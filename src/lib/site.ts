...
export const T = {
  id: {
    ...
    hero_desc: 'Ketika dunia memintamu terus melangkah, kami mengundangmu untuk berhenti sejenak. Breaktime adalah ruang lembut untuk menemukan jalan pulang.',
    hero_cta1: 'Jelajahi Produk', hero_cta2: 'Pelajari Lebih Lanjut', hero_scroll: 'Scroll',
    about_tag: 'Tentang breaktime', about_title_1: "Break doesn't mean broken,", about_title_2: 'it means breaking through.',
    ...
    about_p2: 'Breaktime.id lahir dari kebenaran sederhana: istirahat bukanlah hadiah atas produktivitas. Ia adalah tanah dari mana segalanya tumbuh. Kami menenun psikologi, filsafat, neurosains, kebijaksanaan kuno dan modern — bukan sebagai alat optimasi, melainkan sebagai sahabat bagi jiwa.',
    about_p3: 'Kami tidak memperbaiki orang. Kami berjalan di samping mereka. Dan ketika seseorang siap, kami membantu mereka menemukan bahwa jawaban yang selama ini mereka cari telah ada di dalam diri mereka sejak awal.',
    about_neuro_title: 'Neurosains', about_neuro_desc: 'Memahami ritme alami pembaruan otak', about_psych_title: 'Psikologi', about_psych_desc: 'Pendekatan penuh kasih untuk penyembuhan batin', about_philo_title: 'Filsafat', about_philo_desc: 'Pertanyaan zaman yang membuka pintu baru',
    about_quote: '"Your pain is the breaking of the shell that encloses your understanding."',
    products_tag: 'Produk', products_title_1: 'Cara kami', products_title_2: 'membantumu pulang', products_all: 'Lihat semua produk',
    ...
    social_desc: 'Bergabunglah dengan komunitas breaktime. Kami tidak menyediakan apapun kecuali ruang untuk bersyukur dan teman-teman yang saling menghibur. Tanpa hiruk-pikuk. Tanpa algoritma. Hanya komunitas yang belajar menjadi manusia bersama.',
  ...
  en: {
    ...
    hero_desc: 'When the world asks you to keep going, we invite you to pause. Breaktime is a gentle space to find your way back.',
    hero_cta1: 'Explore Products', hero_cta2: 'Learn More', hero_scroll: 'Scroll',
    ...
    about_neuro_title: 'Neuroscience', about_neuro_desc: "Understanding the brain's natural rhythms of renewal", about_psych_title: 'Psychology', about_psych_desc: 'Compassionate approaches to inner healing', about_philo_title: 'Philosophy', about_philo_desc: 'Timeless questions that open new doorways',
    about_quote: '"Your pain is the breaking of the shell that encloses your understanding."',
...
export const socials = [
  { label: '@breaktime.magic', platform: 'instagram', href: 'https://instagram.com/breaktime.magic' },
];

export const whatsappHref = 'https://wa.me/6282338036703';
